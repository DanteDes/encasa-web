            ...
            {[
              {
                ...
                rating: 5,
                comment:
                  "Excelente trabajo, muy profesional y puntual. Lo recomiendo 100%.",
                date: "Hace 1 semana",
              },
              {
                name: "Carlos López",
                rating: 5,
                comment:
                  "Muy conforme con el resultado. Trabajo prolijo y rápido.",
                date: "Hace 2 semanas",
              },
              {
                ...
                rating: 4,
                comment:
                  "Buen trabajo, aunque tardó un poco más de lo esperado.",
                date: "Hace 1 mes",
              },
            ].map((review, index) => (
              <div
