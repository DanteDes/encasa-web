            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-8 h-8 flex items-center justify-center rounded-lg bg-zinc-800 hover:bg-pink-600 transition-colors text-zinc-400 hover:text-white"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 flex items-center justify-center rounded-lg bg-zinc-800 hover:bg-green-600 transition-colors text-zinc-400 hover:text-white"
                  aria-label="WhatsApp"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
